...
export function Buttons(props : ButtonsProps) : ElementNode {
    ...
    const { wallet, fundingSource, style, locale, remembered, env, fundingEligibility, platform, commit, vault,
        nonce, components, onShippingChange, personalization, userIDToken, content, flow, experiment, fundingPaymentNonce, supportsPopups, supportedNativeBrowser } = normalizeButtonProps(props);
